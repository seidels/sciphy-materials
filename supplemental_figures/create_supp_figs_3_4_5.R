...
#input RF 2D mapping 
RF_treeDist <- read.csv( file = "../figure_4/inference_output/mapping_df_RF.csv")

#input original distances
distances <- read.csv( file = "../figure_4/inference_output/distances_RF.csv")
...
ggsave(paste0(pic_dir,"supp_fig_3.png"), combined_with_title, width = 60, height = 60, units = "cm", dpi = 300)

###########################################
## Plotting in 2D Clustering Information ##
###########################################

CI_treeDist <- read.csv( file = "../figure_4/inference_output/mapping_df_CI.csv")

#input original distances
distances <- read.csv( file = "../figure_4/inference_output/distances_CI.csv")
...
ggsave(paste0(pic_dir,"supp_fig_4.png"), combined_with_title, width = 60, height = 60, units = "cm", dpi = 300)
...
PI_treeDist <- read.csv( file = "../figure_4/inference_output/mapping_df_PI.csv")

#input original distances
distances <- read.csv( file = "../figure_4/inference_output/distances_PI.csv")
...
ggsave(paste0(pic_dir,"supp_fig_5.png"), combined_with_title, width = 60, height = 60, units = "cm", dpi = 300)
